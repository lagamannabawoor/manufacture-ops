...
export const ROLES = {
  admin:      { label: 'Admin',      tabs: ['dashboard','production','purchases','sales','reports','settings'], canWrite: true,  canApprove: true,  canSettings: true  },
  accountant: { label: 'Accountant', tabs: ['dashboard','production','purchases','sales','reports'],            canWrite: true,  canApprove: true,  canSettings: false },
  labour:     { label: 'Labour',     tabs: ['production'],                                                     canWrite: false, canApprove: false, canSettings: false },
  guest:      { label: 'Guest',      tabs: ['dashboard','production','purchases','reports'],                   canWrite: false, canApprove: false, canSettings: false },
};
...
const SEED = {
  ...
  products: [
    { id: 'p1', name: '4" Solid Block',    categoryId: 'pc1', unit: 'pieces', hsnCode: '6810' },
    { id: 'p2', name: '6" Solid Block',    categoryId: 'pc1', unit: 'pieces', hsnCode: '6810' },
    { id: 'p3', name: '8" Solid Block',    categoryId: 'pc1', unit: 'pieces', hsnCode: '6810' },
    { id: 'p4', name: '60mm Paver',        categoryId: 'pc2', unit: 'sqft',   hsnCode: '6810' },
    { id: 'p5', name: '80mm Paver',        categoryId: 'pc2', unit: 'sqft',   hsnCode: '6810' },
    { id: 'p6', name: '4" Hollow Block',   categoryId: 'pc3', unit: 'pieces', hsnCode: '6810' },
    { id: 'p7', name: '6" Hollow Block',   categoryId: 'pc3', unit: 'pieces', hsnCode: '6810' },
    { id: 'p8', name: 'Interlocking Block',categoryId: 'pc4', unit: 'sqft',   hsnCode: '6810' },
  ],
  materialTypes: [
