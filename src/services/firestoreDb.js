...
export const DOC_MAP = {
  master:     ['factories','productCategories','products','materialTypes','laborGroups','installationTeams','bankAccounts','expenseCategories','users','reportEmails','companyInfo'],
  production: ['productionEntries','pendingProduction'],
  materials:  ['materialPurchases'],
  finance:    ['laborPayments','orders','orderPayments','orderDispatches','expenses','installationJobs','installationPayments'],
  sales:      ['quotes','invoices','enquiries'],
  audit:      ['auditLog'],
};
...
const DEFAULT_CONFIG = {
  apiKey:            "AIzaSyCtrG0_JjMltsthWQXZ6hd2er8Hc4T8odQ",
  authDomain:        "urbanmud-bricks-and-bloc-15aec.firebaseapp.com",
  projectId:         "urbanmud-bricks-and-bloc-15aec",
  storageBucket:     "urbanmud-bricks-and-bloc-15aec.firebasestorage.app",
  messagingSenderId: "55120524689",
  appId:             "1:55120524689:web:24ac9cbe5d2597cd4d5630",
};
